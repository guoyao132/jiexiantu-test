...
if (typeof mxVertexHandler != 'undefined')
{
	(function()
	{
		...
		Graph.prototype.dblClick = function(evt, cell)
		{
			if (this.isEnabled())
			{
				if(cell && cell.id && !(cell.id.includes('point-') || cell.id.includes('quyu-'))){
					...
					mxGraph.prototype.dblClick.call(this, evt, null);
				}
			}
		};
		...
		Graph.prototype.createSvgImageExport2 = function()
		{
			var exp = this.createSvgImageExport.apply(this, arguments);
			...
			exp.drawCellState = function(state, canvas)
			{
				...
				if(state.cell.parent!=null&&state.cell.parent.id!=null){
					g.setAttribute('pid', 'cell-' + state.cell.parent.id);
				}
			...
			ignoreSelection, showText, imgExport, linkTarget, hasShadow)
		{
			...
			try
			{
				...
				imgExport = (imgExport != null) ? imgExport : this.createSvgImageExport2();
