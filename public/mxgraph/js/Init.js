...
window.RESOURCES_PATH = window.RESOURCES_PATH || '/grapheditor/resources';
window.RESOURCE_BASE = window.STYLE_PATH || window.RESOURCES_PATH + '/grapheditor';
window.STENCIL_PATH = window.STENCIL_PATH || '/grapheditor/stencils';
